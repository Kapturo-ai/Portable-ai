...
Ce dépôt construit `sticker-card`, un kit qui inspecte des dépôts open source et génère des packages portables pour agents IA.
...
- Maintenir `skills/sticker-card/SKILL.md` comme source de vérité ; les copies sous `.agents/skills/` et `.claude/skills/` sont des projections générées.
